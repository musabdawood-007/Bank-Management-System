...
public partial class WithdrawPage : Page
{
    ...
    public WithdrawPage(string accountNumber)
    {
        InitializeComponent();
    ...
    private void Withdraw_Click(object sender, RoutedEventArgs e)
    {
        ...
        var (success, message) = DatabaseHelper.Withdraw(_accountNumber, amount, DescriptionBox.Text.Trim());
        if (success)
        {
            ShowMessage($"Successfully withdrawn PKR {amount:N0}.", true);
            AmountBox.Clear();
